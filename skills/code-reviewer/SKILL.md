...
description: 複数のAI（Claude/Codex/Gemini）でPRをレビューするスキル。GitHub PRの差分を取得し、各AIの視点を統合した詳細レビューを提供。「PRレビューして」「コードレビューして」「PR#123をチェック」で使用。
---
...
- `codex exec` と `gemini -p` は**並列実行**する
- 両方の完了を待ってから結果統合
- タイムアウト: 120秒
